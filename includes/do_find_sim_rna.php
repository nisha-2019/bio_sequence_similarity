...
<body>
<form id="form1" name="form1" method="post" action="do_ins_rna_per.php">
  <center><p><strong>RNA SIMILARITY</strong>  </p></center>
...
for($i=0;$i<strlen($rw1['seq']);$i++)
{
  ...
  <center><p><strong>Count Details of RNA 1</strong>  </p>
  </center>
  ...
  <center>
  <p>&nbsp;</p>
  <p><strong>Count Details of RNA 2</strong> </p>
  </center>
...
?>
  ...
  <p>&nbsp;</p><center>
  <a href="includes/do_ins_rna_per.php?id1=<?php echo $id[0]; ?>&id2=<?php echo $id1[0]; ?>&p=<?php echo $c; ?>">SAVE RESULT</a></center>
  <p>&nbsp;</p>
</form>
</body>
</html>